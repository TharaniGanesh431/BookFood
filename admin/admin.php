...
<div class="container-fluid">
  <div class="row">
        ...
        <?php
          ...
          if(isset($_POST['filter3']))
          {
            ...
            while($row = mysqli_fetch_assoc($result))
              ...
              echo "<div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Please do Filter </div></div></div></div>";
          ?>
          <div class='row'>
            <div class='col-sm-5'>
              <div class='form-group'>
          ...
          if(isset($_POST['filter3']))
          {
            echo" <select class='form-control' name='status1' id='status'>
          ...
          else
          {
            ...
            echo "<div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Please do Filter </div></div></div></div><br><br><br>";
          }
    ...
    <?php
        ...
        {
          change_food_status($_SESSION['cid'],$_SESSION['ses'],$_POST['food'],$_POST['status1']);
        }
            ...
            <div class="form-group">
              ...
              <?php 
                if(isset($_POST['filter1']))
                  ...
                  echo "<div> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Please do Filter </div> <br><br><br><br><br></div></div></div>";
              ?>
    ...
    <div class="well well-lg">
     ...
     <div class="row">
      <div class="col-sm-5">
        ...
        <?php 
        if(isset($_POST['filter2']))
          echo"<input type='text'  class='form-control' name='quantity' id='quantity'>
          <br>
          ...
          echo "<div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Please do Filter</div> <br><br><br><br>";
        ?>
      </div>
      </div>
     </div>      
...
<div class="col-sm-6">
      <div class="well well-lg">
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="form-group">
            <label for="canteen_id">CANTEEN:</label>
           <?php 
          $query="SELECT * FROM canteen";
          $result=mysqli_query($connect,$query);
    ...
    <div class="col-sm-6">
      <div class="well well-lg">
        ...
        <form action="" method="post">
          ...
          <h4 class="hbold1" >VIEW FOOD DETAILS :</h4><br>
          <div class="row">
            <div class="col-sm-5">
             <div class="form-group">
               <label>CANTEEN:</label>
       ...
       <div class="row">
        ...
        <?php
          if(isset($_POST['filter4']))
          {
            ...
            echo "<div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Please do Filter</div> <br><br><br><br><br><br>";
